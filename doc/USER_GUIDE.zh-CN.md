...
Ante Obsidian 当前主要提供 6 类用户可见功能：
...
- 插件会先在笔记中插入一个“正在运行”的占位提示。
- Ante 会根据你的指令，直接调用相关工具对笔记进行编辑或生成文本。
- 执行完成后，改动会直接应用在当前文档中，占位提示也会自动清理。
...
除了运行配置外，Ante Obsidian 现在还提供了单独的更新检查与预设管理区域。
...
- 本机可以运行标准 `ante` 命令，或可在 Ante Obsidian 设置页中先完成安装
