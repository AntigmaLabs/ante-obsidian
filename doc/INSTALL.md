...
Run the same command again to update an existing manual install in that vault. The script overwrites the `ante/` plugin folder with the latest release archive. Restart Obsidian or reload community plugins after updating.
