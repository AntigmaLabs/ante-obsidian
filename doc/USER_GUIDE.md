...
Ante Obsidian currently provides 6 main user-facing capabilities:
...
- The standard `ante` command runs on your machine, or you can install it first from Ante Obsidian settings
