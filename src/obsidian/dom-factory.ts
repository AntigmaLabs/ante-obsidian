  ...
  appendTo(parent: ObsidianDomParent): T {
    ...
    return (tag === "div"
      ...
      : tag === "span"
        ...
        : host.createEl(tag, options)) as T
  },
})
...
export const button = (
  options?: FactoryOptions,
): FactoryNode<HTMLButtonElement> => createFactoryNode("button", options)

export const textarea = (
  options?: FactoryOptions,
): FactoryNode<HTMLTextAreaElement> => createFactoryNode("textarea", options)
