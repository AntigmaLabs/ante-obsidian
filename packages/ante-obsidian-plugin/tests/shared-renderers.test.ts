...
import { buildApprovalSignature, renderApprovalCard } from "../src/obsidian/approval-card-renderer";
import {
...
test("approval card renderer preserves signature inputs and dispatches decisions", () => {
  ...
  assert.equal(
    signatureWithOwner,
    'task-1|turn-1|Need approval|tool-1:Write:{"path":"a.md"}|tool-2:Read:',
  );
