...
You can install the plugin via the official Obsidian Community Plugins catalog (once approved), or use the automated installer script below inside your terminal:
